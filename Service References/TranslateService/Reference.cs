...
namespace MCGalaxy.TranslateService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private MCGalaxy.TranslateService.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public MCGalaxy.TranslateService.TranslationMatch[] Translations {
            get {
    ...
    public interface LanguageService {
        ...
        MCGalaxy.TranslateService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MCGalaxy.TranslateService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, MCGalaxy.TranslateService.Translation[] translations, string from, string to, MCGalaxy.TranslateService.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        MCGalaxy.TranslateService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MCGalaxy.TranslateService.TranslateOptions options);
        ...
        MCGalaxy.TranslateService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MCGalaxy.TranslateService.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : MCGalaxy.TranslateService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<MCGalaxy.TranslateService.LanguageService>, MCGalaxy.TranslateService.LanguageService {
        ...
        public MCGalaxy.TranslateService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MCGalaxy.TranslateService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, MCGalaxy.TranslateService.Translation[] translations, string from, string to, MCGalaxy.TranslateService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public MCGalaxy.TranslateService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MCGalaxy.TranslateService.TranslateOptions options) {
        ...
        public MCGalaxy.TranslateService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MCGalaxy.TranslateService.TranslateOptions options) {
