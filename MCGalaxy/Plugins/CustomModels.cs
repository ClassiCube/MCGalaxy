...
namespace MCGalaxy {
    public sealed class CustomModelsPlugin : Plugin {
        ...
        class BlockBench {
            public static CustomModelAnim ParseAnim(string name) {
                if (name.CaselessEnds("head")) {
                    Logger.Log(LogType.Warning, "aaaaaaaaaaa");

                    return CustomModelAnim.Head;
                }
                return CustomModelAnim.None;
            }
            ...
            public class JsonRoot {
                ...
                public CustomModelPart[] ToCustomModelParts() {
                    ...
                    foreach (Element e in this.elements) {
                        ...
                        var anim = BlockBench.ParseAnim(e.name);
